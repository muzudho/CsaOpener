namespace Grayscale.ShogiKifuConverter
{
    ...
    public static class RustExe
    {
        ...
        public static int ConvertAnyFileToRpm(TraceableFile inputFile, TraceableFile outputFile)
        {
            ...
            // 起動する実行ファイルのパスを設定する
            info.FileName = LocationMaster.Kw29MasterConfJson.kifuwarabe_wcsc29_exe_path_for_convert_kifu;
            info.WorkingDirectory = Directory.GetParent(LocationMaster.Kw29MasterConfJson.kifuwarabe_wcsc29_exe_path_for_convert_kifu).FullName;
